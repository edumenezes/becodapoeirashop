...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Vendedor}.
 */
@RestController
@RequestMapping("/api")
public class VendedorResource {
    ...
    public ResponseEntity<List<Vendedor>> getAllVendedors(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
