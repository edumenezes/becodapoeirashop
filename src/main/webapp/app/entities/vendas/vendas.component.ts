...
export class VendasComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.vendasService
      ...
      .subscribe(
        (res: HttpResponse<IVendas[]>) => this.paginateVendas(res.body, res.headers),
  ...
  trackId(index: number, item: IVendas) {
    return item.id;
  }
  ...
  protected paginateVendas(data: IVendas[], headers: HttpHeaders) {
